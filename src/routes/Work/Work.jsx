...
import fitmeScreenshot from "../../components/resources/fitme.png";
  ...
  return (
    <>
      ...
      >
        {workArray.map((ele, i) => {
          return (
            <motion.div key={i} className="card-container" variants={galleryVariants} custom={i} exit={{ y: "100vh" }}>
              <Tilt
              ...
              >
                ...
                <div className="layer-3d">
                  <h1>{ele.name}</h1>
                  {ele.githubLink&&<div className="work-links-container">
                    <a
                      href={ele.githubLink}
                      target="_blank"
                      rel="noreferrer"
                    ...
                    <a
                      href="https://workout-progress-tracker.herokuapp.com/"
                      target="_blank"
                      rel="noreferrer"
                      // onClick={() => {
                      // }}
                    >
                     <div className="demo-button"><span>Live</span><span>Demo</span></div>
                    </a>
                  </div>}
                </div>
              </Tilt>
